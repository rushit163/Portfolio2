...
const Skills = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-baseline align-center  max-h-full min-h-[100vh] w-[100vw] bg-black kuchbhi shadow-2xl shadow-black ">
      <div className='flex flex-col justify-baseline  w-[100vw] lg:w-[50vw]  lg:border-r-2   border-slate-200 p-3'>
          ...
          <div className='box borderColor flex flex-row align-center justify-center text-black text-2xl text-justify  mt-5 rounded-xl'>
